...
function getAllProducts(req, res){
    fs.readFile(productFilePath, 'utf8', (err, data) => {
        ...
        res.writeHead(200);
        res.write(JSON.stringify({"message": "Products Retrieved", "data": products}));
        res.end();
    });
...
function getProductById(req, res, id){
    ...
    fs.readFile(productFilePath, 'utf8', (err, data) => {
        ...
        if(productIndex === -1){
            ...
            res.writeHead(200);
            res.write(JSON.stringify({"message": "Product retrieved Successfully", "data": products[productIndex]}));
            res.end();
        }
    });
            ...
            if(err){
                ...
                fs.writeFile(productFilePath, allProducts, (err) => {
                    if(err){
                        ...
                        res.writeHead(201);
                        res.write(JSON.stringify({ "message": "Product created successfully", "data": products }));
                        res.end();
                    }
                });
            ...
            if(err){
                ...
                fs.writeFile(productFilePath, updatedProducts, (err) => {
                    if(err){
                        ...
                        res.writeHead(201);
                        res.write(JSON.stringify({ "message": "Product Updated Successfully", "data": products[productIndex]}));
                        res.end();
                    }
                });
            }
